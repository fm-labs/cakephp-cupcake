<?php $this->Breadcrumbs->add(__d('content','Users'), ['action' => 'index']); ?>
<?php $this->Breadcrumbs->add(__d('content','Edit {0}', __d('content','User'))); ?>
<div class="actions">
...
<div class="users ui form">
    <h2><?= __d('content','Edit {0}', __d('content','User')) ?></h2>
