...
<div class="pages">
    ...
    <div class="be-tabs">
        ...
        <div class="ui top attached tabular menu">
            <a class="item" data-tab="tab-posts"><?= __d('banana','Related Posts'); ?></a>
            <a class="item" data-tab="tab-content-modules"><?= __d('banana','Related content modules'); ?></a>
            <a class="item" data-tab="tab-link-module"><?= __d('banana','Link existing module'); ?></a>
        </div>
