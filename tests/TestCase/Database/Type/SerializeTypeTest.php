 ...
 *
 * This is a copy of \Cake\Test\TestCase\Database\Type\SerializeTypeTest class,
 * thus performing the same tests on own SerializeType implementation
 */
class SerializeTypeTest extends TestCase
{
    ...
    public function testToPHP()
    {
        ...
        $this->assertSame('word', $this->type->toPHP(serialize('word'), $this->driver));
        $this->assertSame(2.123, $this->type->toPHP(serialize(2.123), $this->driver));
    }
    ...
    public function testToDatabase()
    {
        ...
        $this->assertSame(serialize('word'), $this->type->toDatabase('word', $this->driver));
        $this->assertSame(serialize(2.123), $this->type->toDatabase(2.123, $this->driver));
        $this->assertSame(serialize(['a' => 'b']), $this->type->toDatabase(['a' => 'b'], $this->driver));
    }
